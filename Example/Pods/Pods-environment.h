...
// CURestKit
#define COCOAPODS_POD_AVAILABLE_CURestKit
#define COCOAPODS_VERSION_MAJOR_CURestKit 1
#define COCOAPODS_VERSION_MINOR_CURestKit 0
#define COCOAPODS_VERSION_PATCH_CURestKit 2
